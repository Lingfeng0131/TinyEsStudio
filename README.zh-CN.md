...
Tiny ES Studio 是一个轻量但实用的 Elasticsearch 桌面工作台，适合开发、测试、运维在日常排查时快速查看索引、查询文档、编辑数据以及执行 DSL 请求。
...
- 快速切换集群与索引
- 以类表格方式查看、编辑、删除文档
- 在独立 DSL 控制台执行 Elasticsearch 请求
- 查看索引设置与映射
- 支持浅色与暗黑主题切换
...
连接成功后会自动加载索引列表。可以先筛选索引，再进入表格查询或 DSL 操作。
